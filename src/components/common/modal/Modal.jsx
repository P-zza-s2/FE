...
function Modal({ modalstate, value, value_exp, step, onJdChange, onexpChange }) {
      ...
      case '1':
        return (
          <>
            ...
            <button className={`modal-button ${jdvalue ? 'clicked' : ''}`} onClick={() => setModal(false)}>
              확인
            </button>
          </>
        );
      case '3':
        return (
          <>
            ...
            <button className={`modal-button ${expvalue ? 'clicked' : ''}`} onClick={() => setModal(false)}>
              확인
            </button>
          </>
        );
