  ...
  return (
    <>
      ...
      <div className="infobox">
        {modalOpen && <Modal step="1" value={value} modalstate={modalOpen} onJdChange={handleChange}></Modal>}
        ...
        <Input name="portfolio_url" value={portfolio} placeholder="url을 입력하세요" onChange={handleChange}>
          포트폴리오
        </Input>
      </div>
    </>
