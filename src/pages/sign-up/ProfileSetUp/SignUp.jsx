...
import BasicInfoPage from 'components/units/sign-up/Step1';
import SkillSelectionPage from 'components/units/sign-up/Step2';
import ExperienceInputPage from 'components/units/sign-up/Step3/Step3';
import CompletionPage from 'components/units/sign-up/Step4';
...
function SignUp() {
  ...
  const renderContent = () => {
    switch (value) {
      ...
      case 2:
        return <SkillSelectionPage value={value} name="skills" skills={userValue.skills} onChange={handleChange} />;
      case 3:
        return (
          <ExperienceInputPage
            value={value}
  ...
  return (
    <div className="sign-up-container">
      {value < 4 && <Progress value={value} onClick={handleProgressClick}></Progress>}
      <div>
        {renderContent()}
        <Button
