  ...
  return (
    <div className="detail-section">
      <p className="detail-content">
        ...
        관리 앱 프로젝트 제로(PROJECT ZERO)를 개발하고 있습니다. 프로젝트 제로(PROJECT ZERO)는 팀 프로젝트의 모든 과정을
        한 곳에서 관리할 수 있는 앱입니다. 일정 관리 커뮤니케이션 협업 성과 관리 프로젝트 제로(PROJECT ZERO)는 팀원들의
        소통과 협업을 강화하고, 프로젝트의 효율성과 생산성을 높여 팀 프로젝트의 성공을 돕습니다. 저희는 프로젝트
        제로(PROJECT ZERO)를 통해 팀 프로젝트의 성공을 누구나 경험할 수 있는 세상을 만들고자 합니다.
      </p>
    </div>
  );
}
